function Colors = color_picker(N, Order, Color)
...
AllColors.pink = [228 164 198];
AllColors.black = [0 0 0];
AllColors.gray = [.5 .5 .5];
AllColors.brown = [153, 102, 51];
...
elseif numel(N) == 2
    ...
    if N(1) == 1
        ...
        Colors = chART.external.hsl2rgb(all_hsl_Colors);
    else
